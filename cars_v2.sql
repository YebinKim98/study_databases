...
CREATE TABLE CARS
(
  COMPANY_NAME_ID VARCHAR(50) NOT NULL COMMENT '회사이름_ID',
  CARS YEAR_ID    VARCHAR(50) NOT NULL COMMENT '연식_ID',
  CARS_NAME_ID    VARCHAR(50) NOT NULL COMMENT '자동차 이름_ID',
...
(
  CARS YEAR    VARCHAR(50) NOT NULL COMMENT '자동차 연식',
  CARS YEAR_ID VARCHAR(50) NOT NULL COMMENT '연식_ID',
...
(
  CARS NAME    VARCHAR(50) NOT NULL COMMENT '자동차이름',
  CARS_NAME_ID VARCHAR(50) NOT NULL COMMENT '자동차 이름_ID',
...
(
  OPTION_CODE    VARCHAR(50) NOT NULL COMMENT '옵션_ID',
  CARS_OPTION_ID VARCHAR(50) NOT NULL COMMENT '자동차 옵션_ID'
);

CREATE TABLE COMPANY NAME
(
  COMPANY NAME    VARCHAR(50) NOT NULL COMMENT '회사이름',
  COMPANY_NAME_ID VARCHAR(50) NOT NULL COMMENT '회사이름_ID',
...
(
  OPTION NAME VARCHAR(50) NOT NULL COMMENT '옵션명',
  OPTION_CODE VARCHAR(50) NOT NULL COMMENT '옵션_ID',
